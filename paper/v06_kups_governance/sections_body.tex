...
\item
  ...
  17.7; experimental CO₂/CHA ≈ 20--30) on CO₂/CHA --- its actual
  training domain → governance screen-passes it}. The screen q\_st is 17.7 kJ/mol against a reference anchor of ≈21 (≈3 kJ/mol low, −3.3 below strict): a screen-pass, not an accuracy certificate. On Ar/CHA (a noble gas it
...
\item
  ...
  \texttt{tail\_correction:\ false} drops K\_H −16 \%, q\_st −0.49 --- a
