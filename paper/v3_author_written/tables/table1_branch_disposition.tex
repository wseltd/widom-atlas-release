...
CO\textsubscript{2} (Maia 2023 explicit-hydrogen, charged). Every branch listed is
evaluated at 298~K: the locked case matrix records $298.15$~K for 1a--1d, 6b and
6c and the global default $298.0$~K for the remainder, with 3a additionally
cross-checked at $323$~K.}\label{tab:branch-disposition}\\
\toprule
...
6b & MFI + Kr & Garc\'\i a-P\'erez framework\cite{GarciaPerez2007} + Talu cross-pair & $+0.071$ & $-4.17$ & within $2\sigma$ & $Q_{st}$ reference is a van't Hoff fit \\
...
6a & MFI + CH\textsubscript{4} & Garc\'\i a-P\'erez 2007\cite{GarciaPerez2007} + Dubbeldam 2004 UA\cite{Dubbeldam2004UA} & $-0.347$ & $-2.43$ & $>3\sigma$ & united-atom under-binds \\
\addlinespace[2pt]
